...
<?php if (isset($_SESSION['message'])): ?>
    <?php $color = strpos($_SESSION['message'], 'successfully') !== false ? 'green' : 'red'; ?>
    <p style="color: <?= $color ?>; text-align: center; font-weight: bold;"><?= htmlspecialchars($_SESSION['message']) ?></p>
